(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('@angular/animations'), require('@angular/forms'), require('@angular/cdk/overlay'), require('rxjs/Subject'), require('rxjs/observable/fromEvent'), require('rxjs/operators/debounceTime'), require('rxjs/operators/mapTo'), require('rxjs/operators/merge'), require('timers'), require('moment'), require('moment/locale/zh-cn')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', '@angular/common', '@angular/animations', '@angular/forms', '@angular/cdk/overlay', 'rxjs/Subject', 'rxjs/observable/fromEvent', 'rxjs/operators/debounceTime', 'rxjs/operators/mapTo', 'rxjs/operators/merge', 'timers', 'moment', 'moment/locale/zh-cn'], factory) :
	(factory((global['at-ng'] = {}),global.ng.core,global.ng.common,global.ng.animations,global.ng.forms,global.ng.cdk.overlay,global.Rx,global.Rx.Observable,global.Rx.Observable.prototype,global.Rx.Observable.prototype,global.Rx.Observable.prototype,global.timers,global.moment));
}(this, (function (exports,core,common,animations,forms,overlay,Subject,fromEvent,debounceTime,mapTo,merge,timers,moment) { 'use strict';
...
var ButtonComponent = (function () {
     ...
     * @return {?}
     */
    ButtonComponent.prototype._setClassMap =
        function () {
            var _this = this;
...
var HollowDirective = (function () {
    ...
    /** @nocollapse */
    HollowDirective.ctorParameters = function () {
        return [
            { type: core.ElementRef, },
            { type: core.Renderer2, },
        ];
...
var MenuItemGroupComponent = (function () {
    ...
    /** @nocollapse */
    MenuItemGroupComponent.ctorParameters = function () {
        return [
            { type: MenuComponent, decorators: [{ type: core.Inject, args: [MenuComponent,] },] },
        ];
    };
...
var ColComponent = (function () {
    ...
    /** @nocollapse */
    ColComponent.ctorParameters = function () {
        return [
            { type: core.ElementRef, },
            { type: core.Renderer2, },
        ];
...
var TagComponent = (function () {
     ...
     * @return {?}
     */
    TagComponent.prototype._setClassMap =
        function () {
            var _this = this;
            if (this.tagSpan) {
     ...
     * @return {?}
     */
    TagComponent.prototype.ngAfterContentInit =
        function () {
        };
    /**
     * @return {?}
     */
    TagComponent.prototype.ngAfterViewChecked =
        function () {
            if (!this.viewChecked) {
                this._setClassMap();
            }
     ...
     * @return {?}
     */
    TagComponent.prototype.closeTag =
        function () {
            this.closed = true;
...
var InputComponent = (function () {
     ...
     * @return {?}
     */
    InputComponent.prototype.ngAfterContentInit =
        function () {
     ...
     * @return {?}
     */
    InputComponent.prototype.numberUp =
        function () {
     ...
     * @return {?}
     */
    InputComponent.prototype.numberDown =
        function () {
            this._value = this._value || 0;
     ...
     * @return {?}
     */
    InputComponent.prototype.setNumberStatus =
        function () {
            if (this.max && this._value >= this.max) {
                this.isMax = true;
     ...
     * @return {?}
     */
    InputComponent.prototype.focusOut =
        function ($event) {
...
var SelectComponent = (function () {
     ...
     * @return {?}
     */
    SelectComponent.prototype.updateFilterOption =
        function (setText) {
            var _this = this;
            if (setText === void 0) {
                setText = false;
     ...
     * @return {?}
     */
    SelectComponent.prototype.addOption =
        function (option) {
            var _this = this;
     ...
     * @return {?}
     */
    SelectComponent.prototype.handleDrop =
        function (e) {
            if (this.disabled) {
                return;
            }
     ...
     * @return {?}
     */
    SelectComponent.prototype.dropUp =
        function () {
            var _this = this;
            if (this.disabled) {
                return;
     ...
     * @return {?}
     */
    SelectComponent.prototype.selectMultipleOption =
     ...
     * @return {?}
     */
    SelectComponent.prototype.isInSet =
        function (set, option) {
     ...
     * @return {?}
     */
    SelectComponent.prototype.updateSelectedOption =
     ...
     * @return {?}
     */
    SelectComponent.prototype.clearAllSelectedOption =
        function () {
            this._selectedOptions = new Set();
        };
    /**
     ...
     * @return {?}
     */
    SelectComponent.prototype.clearData =
        function (e) {
            e.stopPropagation();
     ...
     * @return {?}
     */
    SelectComponent.prototype.rejectData =
        function (e, data) {
            e.stopPropagation();
            // 如果是tag
            if (data.isTag) {
     ...
     * @return {?}
     */
    SelectComponent.prototype.onKey =
        function ($event) {
            if ($event.code == 'Enter') {
     ...
     * @return {?}
     */
    SelectComponent.prototype.forceUpdateSelectedOption =
        function (value) {
            var _this = this;
            if (value == null) {
                return;
     ...
     * @return {?}
     */
    SelectComponent.prototype.updateTop =
        function () {
            var _this = this;
            setTimeout(function (_) {
     ...
     * @return {?}
     */
    SelectComponent.prototype.resetOption =
        function () {
...
var SwitchComponent = (function () {
     ...
     * @return {?}
     */
    SwitchComponent.prototype.switch =
        function () {
            if (!this.disabled) {
...
var SliderComponent = (function () {
     ...
     * @return {?}
     */
    SliderComponent.prototype.mouseDown =
        function () {
     ...
     * @return {?}
     */
    SliderComponent.prototype.mouseUp =
        function () {
            console.log('mouseUp');
        };
...
var DropdownMenuItemComponent = (function () {
    ...
    /** @nocollapse */
    DropdownMenuItemComponent.ctorParameters = function () {
        return [
            { type: core.ElementRef, },
            { type: core.Renderer2, },
        ];
...
var DropdownComponent = (function () {
    function DropdownComponent(_renderer, _changeDetector) {
        ...
        this.trigger = 'hover';
        this._visibleChange = new Subject.Subject();
        this.atVisibleChange = new core.EventEmitter();
     ...
     * @return {?}
     */
    DropdownComponent.prototype.toBoolean =
        function (value) {
     ...
     * @return {?}
     */
    DropdownComponent.prototype._onClickEvent =
        function () {
     ...
     * @return {?}
     */
    DropdownComponent.prototype._onMouseEnterEvent =
        function (e) {
     ...
     * @return {?}
     */
    DropdownComponent.prototype._onMouseLeaveEvent =
        function (e) {
            if (this.trigger === 'hover') {
                this._hide();
            }
     ...
     * @return {?}
     */
    DropdownComponent.prototype._hide =
        function () {
     ...
     * @return {?}
     */
    DropdownComponent.prototype._show =
        function () {
     ...
     * @return {?}
     */
    DropdownComponent.prototype._onPositionChange =
        function (position) {
     ...
     * @return {?}
     */
    DropdownComponent.prototype._clickDropDown =
        function ($event) {
            $event.stopPropagation();
            if (this.autoClose) {
                this._hide();
     ...
     * @return {?}
     */
    DropdownComponent.prototype._setTriggerWidth =
        function () {
     ...
     * @return {?}
     */
    DropdownComponent.prototype._startSubscribe =
        function (observable$) {
            this._subscription = observable$.pipe(debounceTime.debounceTime(50))
    ...
    DropdownComponent.prototype.ngAfterViewInit =
        function () {
            var /** @type {?} */ mouse$;
            if (this.trigger === 'hover') {
                var /** @type {?} */ mouseEnterOrigin$ = fromEvent.fromEvent(this._atOrigin.elementRef.nativeElement, 'mouseenter').pipe(mapTo.mapTo(true));
                var /** @type {?} */ mouseLeaveOrigin$ = fromEvent.fromEvent(this._atOrigin.elementRef.nativeElement, 'mouseleave').pipe(mapTo.mapTo(false));
                mouse$ = mouseEnterOrigin$.pipe(merge.merge(mouseLeaveOrigin$));
            }
            if (this.trigger === 'click') {
                mouse$ = fromEvent.fromEvent(this._atOrigin.elementRef.nativeElement, 'click').pipe(mapTo.mapTo(true));
                this._renderer.listen(this._atOrigin.elementRef.nativeElement, 'click', function (e) {
                    e.preventDefault();
                });
            }
            var /** @type {?} */ observable$ = mouse$.pipe(merge.merge(this._visibleChange));
    ...
    DropdownComponent.propDecorators = {
        ...
        "_atOrigin": [{ type: core.ContentChild, args: [DropdownDirective,] },],
        "_atMenu": [{ type: core.ContentChild, args: [DropdownMenuItemComponent,] },],
        "trigger": [{ type: core.Input },],
        "_visibleChange": [{ type: core.Output },],
        "atVisibleChange": [{ type: core.Output },],
        "_cdkOverlay": [{ type: core.ViewChild, args: [overlay.CdkConnectedOverlay,] },],
...
var DropMenuListComponent = (function (_super) {
    ...
    /** @nocollapse */
    DropMenuListComponent.ctorParameters = function () {
        return [
            { type: core.ElementRef, },
            { type: core.Renderer2, },
        ];
...
var ComponentCreatorBase = (function () {
    ...
    /** @nocollapse */
    ComponentCreatorBase.ctorParameters = function () {
        return [
...
var ComponentCreator = (function () {
     ...
     * @return {?}
     */
    ComponentCreator.prototype.create =
        function () {
            // setTimeout(() => {
     ...
     * @return {?}
     */
    ComponentCreator.prototype.remove =
        function () {
     ...
     * @return {?}
     */
    ComponentCreator.prototype.getElem =
        function () {
     ...
     * @return {?}
     */
    ComponentCreator.prototype.getDom =
        function () {
            return this.domElem;
        };
...
var NotificationBaseService = (function (_super) {
     ...
     * @return {?}
     */
    NotificationBaseService.prototype.addMessage =
        function (config) {
    ...
    /** @nocollapse */
    NotificationBaseService.ctorParameters = function () {
        return [
...
var AtNotificationService = (function (_super) {
     ...
     * @return {?}
     */
    AtNotificationService.prototype.success =
        function (options) {
            if (options === void 0) {
                options = {};
            }
     ...
     * @return {?}
     */
    AtNotificationService.prototype.info =
        function (options) {
            if (options === void 0) {
                options = {};
            }
     ...
     * @return {?}
     */
    AtNotificationService.prototype.show =
        function (options) {
            if (options === void 0) {
                options = {};
            }
     ...
     * @return {?}
     */
    AtNotificationService.prototype.warning =
        function (options) {
            if (options === void 0) {
                options = {};
            }
     ...
     * @return {?}
     */
    AtNotificationService.prototype.error =
        function (options) {
            if (options === void 0) {
                options = {};
            }
    ...
    /** @nocollapse */
    AtNotificationService.ctorParameters = function () {
        return [
...
var AtGlobalMonitorService = (function () {
     ...
     * @return {?}
     */
    AtGlobalMonitorService.prototype.clickDocumentObserve =
        function () {
            var _this = this;
...
var ModalBodyDirective = (function () {
    ...
    /** @nocollapse */
    ModalBodyDirective.ctorParameters = function () {
        return [
            { type: core.ElementRef, },
        ];
    };
...
var ModalComponent = (function () {
     ...
     * @return {?}
     */
    ModalComponent.prototype.setShow =
        function () {
            var _this = this;
            this.state = 'enter';
            setTimeout(function (_) {
     ...
     * @return {?}
     */
    ModalComponent.prototype.setStyle =
        function () {
     ...
     * @return {?}
     */
    ModalComponent.prototype.cancelFromMask =
        function (e) {
     ...
     * @return {?}
     */
    ModalComponent.prototype.headerContains =
        function () {
    ...
    ModalComponent.propDecorators = {
        ...
        "_overlay": [{ type: core.ViewChild, args: ['overlays',] },],
        "body": [{ type: core.ContentChild, args: [ModalBodyDirective,] },],
        "closeable": [{ type: core.Input },],
...
var ModalBaseService = (function (_super) {
    ...
    /** @nocollapse */
    ModalBaseService.ctorParameters = function () {
        return [
            { type: ComponentCreatorBase, },
        ];
    };
...
var AtModalService = (function () {
     ...
     * @return {?}
     */
    AtModalService.prototype.modal =
        function (config) {
            var _this = this;
     ...
     * @return {?}
     */
    AtModalService.prototype.success =
        function (config) {
     ...
     * @return {?}
     */
    AtModalService.prototype.error =
        function (config) {
            this.setConfirm(config);
            config.status = 'error';
            this.modal(config);
     ...
     * @return {?}
     */
    AtModalService.prototype.warning =
        function (config) {
            this.setConfirm(config);
     ...
     * @return {?}
     */
    AtModalService.prototype.confirm =
        function (config) {
            this.setConfirm(config);
            config.status = 'info';
            this.modal(config);
     ...
     * @return {?}
     */
    AtModalService.prototype.setConfirm =
        function (config) {
    ...
    /** @nocollapse */
    AtModalService.ctorParameters = function () {
        return [
...
var PagenationComponent = (function () {
     ...
     * @return {?}
     */
    PagenationComponent.prototype.ngOnInit =
        function () {
        };
     ...
     * @return {?}
     */
    PagenationComponent.prototype._buildIndexes =
        function () {
     ...
     * @return {?}
     */
    PagenationComponent.prototype._jumpPage =
        function (index) {
     ...
     * @return {?}
     */
    PagenationComponent.prototype._jumpBefore =
        function (pageSize) {
     ...
     * @return {?}
     */
    PagenationComponent.prototype._jumpAfter =
        function (pageSize) {
            this._jumpPage(this._current + Math.round(pageSize / 2));
        };
    /**
     ...
     * @return {?}
     */
    PagenationComponent.prototype._atPageIndexChange =
        function (value) {
     ...
     * @return {?}
     */
    PagenationComponent.prototype._atPageSizeChange =
        function (value) {
            this.pageSize = value;
...
var AtBreadItemDirective = (function () {
    ...
    // }
    /** @nocollapse */
    AtBreadItemDirective.ctorParameters = function () {
        return [
            { type: core.ElementRef, },
...
var AtMessageContainerService = (function (_super) {
     ...
     * @return {?}
     */
    AtMessageContainerService.prototype.addMessage =
        function (config) {
            this.getElem().instance.addMessage(config);
        };
    ...
    /** @nocollapse */
    AtMessageContainerService.ctorParameters = function () {
        return [
            { type: ComponentCreatorBase, },
        ];
    };
...
var AtMessageService = (function () {
     ...
     * @return {?}
     */
    AtMessageService.prototype.success =
        function (options) {
            if (options === void 0) {
                options = {};
            }
     ...
     * @return {?}
     */
    AtMessageService.prototype.info =
        function (options) {
            if (options === void 0) {
                options = {};
            }
     ...
     * @return {?}
     */
    AtMessageService.prototype.show =
        function (options) {
            if (options === void 0) {
                options = {};
            }
     ...
     * @return {?}
     */
    AtMessageService.prototype.warning =
        function (options) {
            if (options === void 0) {
                options = {};
            }
     ...
     * @return {?}
     */
    AtMessageService.prototype.error =
        function (options) {
            if (options === void 0) {
                options = {};
            }
     ...
     * @return {?}
     */
    AtMessageService.prototype.loading =
        function (options) {
    ...
    /** @nocollapse */
    AtMessageService.ctorParameters = function () {
        return [
...
var PopTriggerDirective = (function () {
    ...
    /** @nocollapse */
    PopTriggerDirective.ctorParameters = function () {
        return [
            { type: core.ElementRef, },
        ];
    };
...
var PopoverComponent = (function () {
     ...
     * @return {?}
     */
    PopoverComponent.prototype.toBoolean =
        function (value) {
            return value === '' || (value && value !== 'false');
        };
     ...
     * @return {?}
     */
    PopoverComponent.prototype._onClickEvent =
        function () {
            if (this.trigger === 'click') {
                this._show();
            }
     ...
     * @return {?}
     */
    PopoverComponent.prototype._onMouseEnterEvent =
        function (e) {
            if (this.trigger === 'hover') {
                this._show();
            }
     ...
     * @return {?}
     */
    PopoverComponent.prototype._onMouseLeaveEvent =
        function (e) {
            if (this.trigger === 'hover') {
                this._hide();
            }
     ...
     * @return {?}
     */
    PopoverComponent.prototype._hide =
        function () {
            this._visibleChange.next(false);
        };
    /**
     * @return {?}
     */
    PopoverComponent.prototype._show =
        function () {
            this._visibleChange.next(true);
        };
    /**
     ...
     * @return {?}
     */
    PopoverComponent.prototype._onPositionChange =
        function (position) {
            this._dropDownPosition = position.connectionPair.originY;
        };
    /**
     ...
     * @return {?}
     */
    PopoverComponent.prototype._clickDropDown =
        function ($event) {
            $event.stopPropagation();
            if (this.atClickHide) {
                this._hide();
     ...
     * @return {?}
     */
    PopoverComponent.prototype._setTriggerWidth =
        function () {
            this._triggerWidth = this._atOrigin.elementRef.nativeElement.getBoundingClientRect().width;
            /** should remove after https://github.com/angular/material2/pull/8765 merged **/
            if (this._cdkOverlay && this._cdkOverlay.overlayRef) {
     ...
     * @return {?}
     */
    PopoverComponent.prototype._startSubscribe =
        function (observable$) {
            this._subscription = observable$.pipe(debounceTime.debounceTime(50))
                .subscribe(this._onVisibleChange);
        };
    ...
    PopoverComponent.propDecorators = {
        "_atMenu": [{ type: core.ContentChild, args: [DropdownMenuItemComponent,] },],
        "_atOrigin": [{ type: core.ContentChild, args: [PopTriggerDirective,] },],
        "trigger": [{ type: core.Input },],
        "_visibleChange": [{ type: core.Output },],
        "atVisibleChange": [{ type: core.Output },],
        "_cdkOverlay": [{ type: core.ViewChild, args: [overlay.CdkConnectedOverlay,] },],
        "atClickHide": [{ type: core.Input },],
        "atVisible": [{ type: core.Input },],
        "placement": [{ type: core.Input },],
    };
...
var AtFormFeedbackDirective = (function () {
     ...
     * @return {?}
     */
    AtFormFeedbackDirective.prototype._isDirtyAndError =
        function (name) {
...
var DatetimepickerComponent = (function () {
     ...
     * @return {?}
     */
    DatetimepickerComponent.prototype.onDocumentClick =
        function (event) {
     ...
     * @return {?}
     */
    DatetimepickerComponent.prototype.preYear =
        function () {
     ...
     * @return {?}
     */
    DatetimepickerComponent.prototype.nextYear =
        function () {
            this.atYear = this.atYear + 1;
        };
    /**
     * @return {?}
     */
    DatetimepickerComponent.prototype.preMonth =
        function () {
            if (this.atMonth - 1 < 0) {
                this.atMonth = 11;
                this.preYear();
     ...
     * @return {?}
     */
    DatetimepickerComponent.prototype.nextMonth =
        function () {
     ...
     * @return {?}
     */
    DatetimepickerComponent.prototype.clickDate =
        function (date) {
     ...
     * @return {?}
     */
    DatetimepickerComponent.prototype.updateDate =
        function (value) {
     ...
     * @return {?}
     */
    DatetimepickerComponent.prototype.clickMonth =
        function (month) {
     ...
     * @return {?}
     */
    DatetimepickerComponent.prototype.clickYear =
        function (year) {
            this.atYear = year;
            this.atType = 'month';
        };
     ...
     * @return {?}
     */
    DatetimepickerComponent.prototype.setCal =
        function (s) {
            this.atType = s;
        };
    /**
     * @return {?}
     */
    DatetimepickerComponent.prototype.preCentury =
        function () {
     ...
     * @return {?}
     */
    DatetimepickerComponent.prototype.nextCenury =
        function () {
            this.atYear = this.atYear + 10;
        };
    /**
     * @return {?}
     */
    DatetimepickerComponent.prototype.choosePicker =
        function () {
            this.show = true;
        };
...
var AtFormatPipe = (function () {
     ...
     * @return {?}
     */
    AtFormatPipe.prototype.transform =
...
var AtTabInkDirective = (function () {
     ...
     * @return {?}
     */
    AtTabInkDirective.prototype.alignToElement =
        function (element) {
            var _this = this;
            this.show();
     ...
     * @return {?}
     */
    AtTabInkDirective.prototype.show =
        function () {
     ...
     * @return {?}
     */
    AtTabInkDirective.prototype.setDisplay =
        function (value) {
     ...
     * @return {?}
     */
    AtTabInkDirective.prototype.hide =
        function () {
     ...
     * @return {?}
     */
    AtTabInkDirective.prototype._getLeftPosition =
        function (element) {
     ...
     * @return {?}
     */
    AtTabInkDirective.prototype._getElementWidth =
        function (element) {
     ...
     * @return {?}
     */
    AtTabInkDirective.prototype._getTopPosition =
        function (element) {
     ...
     * @return {?}
     */
    AtTabInkDirective.prototype._getElementHeight =
        function (element) {
    ...
    /** @nocollapse */
    AtTabInkDirective.ctorParameters = function () {
        return [
            { type: core.Renderer2, },
            { type: core.ElementRef, },
            { type: core.NgZone, },
...
var TabLabelDirective = (function () {
    ...
    /** @nocollapse */
    TabLabelDirective.ctorParameters = function () {
        return [
            { type: core.ElementRef, },
        ];
    };
...
var StepsComponent = (function () {
     ...
     * @return {?}
     */
    StepsComponent.prototype.addStep =
        function (step) {
     ...
     * @return {?}
     */
    StepsComponent.prototype.stepWidth =
        function (i) {
     ...
     * @return {?}
     */
    StepsComponent.prototype.isLast =
        function (i) {
     ...
     * @return {?}
     */
    StepsComponent.prototype.ngAfterViewInit =
        function () {
            var _this = this;
    ...
    StepsComponent.propDecorators = {
        ...
        "stepList": [{ type: core.ViewChildren, args: ['steps',] },],
    };
...
exports.AtBreadItemComponent = AtBreadItemComponent;
...
exports.ɵq = ComponentCreator;
exports.ɵg = AtFormatPipe;
exports.ɵd = DropdownDirective;
exports.ɵe = ModalBodyDirective;
exports.ɵf = PopTriggerDirective;
exports.ɵp = StepComponent;
exports.ɵo = StepsComponent;
exports.ɵl = AtTabInkDirective;
exports.ɵj = TabBodyComponent;
exports.ɵi = TabContentComponent;
exports.ɵk = TabHeaderComponent;
exports.ɵn = TabLabelDirective;
exports.ɵm = TabNavsComponent;
exports.ɵh = TabSetComponent;
