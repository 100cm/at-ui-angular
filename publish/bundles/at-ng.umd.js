(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('@angular/animations'), require('@angular/forms'), require('timers'), require('moment'), require('moment/locale/zh-cn')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', '@angular/common', '@angular/animations', '@angular/forms', 'timers', 'moment', 'moment/locale/zh-cn'], factory) :
	(factory((global['at-ng'] = {}),global.ng.core,global.ng.common,global.ng.animations,global.ng.forms,global.timers,global.moment));
}(this, (function (exports,core,common,animations,forms,timers,moment) { 'use strict';
...
exports.ɵe = ComponentCreator;
exports.ɵd = AtFormatPipe;
