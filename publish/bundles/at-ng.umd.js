(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('@angular/animations'), require('@angular/forms'), require('@angular/platform-browser'), require('timers'), require('moment'), require('moment/locale/zh-cn')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', '@angular/common', '@angular/animations', '@angular/forms', '@angular/platform-browser', 'timers', 'moment', 'moment/locale/zh-cn'], factory) :
	(factory((global['at-ng'] = {}),global.ng.core,global.ng.common,global.ng.animations,global.ng.forms,global.ng.platformBrowser,global.timers,global.moment));
}(this, (function (exports,core,common,animations,forms,platformBrowser,timers,moment) { 'use strict';
...
var CalendarComponent = (function () {
    ...
    CalendarComponent.prototype.buildCentury = function (year) {
        var /** @type {?} */ century = [];
        var /** @type {?} */ temparray = [];
        for (var _b = 0, _c = Array.from(Array(20).keys()); _b < _c.length; _b++) {
            var i = _c[_b];
