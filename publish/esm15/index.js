...
var SelectComponent = (function () {
    function SelectComponent() {
        ...
        this.unSelectMultipleOption = function (option, $event, emitChange) {
            ...
            if (emitChange) {
                var /** @type {?} */ arrayOptions = /** @type {?} */ (Array.from(_this._selectedOptions));
    ...
    function (option, $event) {
        ...
        var /** @type {?} */ arrayOptions = /** @type {?} */ (Array.from(this._selectedOptions));
     ...
     */
    function (set, option) {
        var /** @type {?} */ ined = ((/** @type {?} */ (Array.from(set)))).find(function (data) {
