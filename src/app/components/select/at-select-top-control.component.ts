  ...
  template: `
    ...
    <ng-container *ngIf="isSingleMode">
      ...
      <div class="at-select__selection">
        ...
        <i *ngIf="allowClear" (click)="clear($event)"
           class="icon icon-x at-select__clear ng-tns-c14-34 ng-star-inserted" style="background: white;z-index: 2"></i>
      </div>
    </ng-container>
    ...
    <div class="at-select__selection"
      ...
      <ng-container *ngFor="let value of atListOfSelectedValue">
        ...
        >
          <span class="at-tag__text">{{ getPropertyFromValue(value, 'atLabel') || value }}</span>
